...
public class RevistaCtrl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if((ID.isEmpty())&&(nome.isEmpty())&&(ANO.isEmpty())&&(mes.isEmpty())&&(QTPG.isEmpty())){
		    ...
		    if((ANO.matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$"))){
		    ...
		    if((QTPG.matches("^[a-zA-ZÁÂÃÀÇÉÊÍÓÔÕÚÜáâãàçéêíóôõúü]*$"))){
		    	JOptionPane.showMessageDialog(null,"Erro...Quantidade de Páginas Informado Incorretamente...!!!");
			    request.getRequestDispatcher("CadastroRevista.jsp").forward(request, response);
				vr3=false;
		    }else{
		    	vr3=true;
		    ...
		    if((vr1==true)&&(vr2==true)&&(vr3==true)){
			  ...
			  if(nome.length()>7){
				...
				JOptionPane.showMessageDialog(null,"Erro...Nome requer no minimo 7 caracteres...!!");
			  }
			
		  	  if(ano<=2018){
				 vr5=true;
			  }else{
				 JOptionPane.showMessageDialog(null,"Erro...Ano não corresponde a um Ano valido...!!");
			  }
			
			  if(qtdpg>20){
				 vr6=true;
			  }else{
				 JOptionPane.showMessageDialog(null,"Erro...Quantidade de Paginas da Revista é Insuficiente...!!");
			  }
